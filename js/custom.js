document.addEventListener('DOMContentLoaded', function(){
  Typed.new('.intro-text', {
    strings: ["^600 Kumar Shraiyash.", "^600 a  Full stack Developer.", "^1000 an Angular developer.", "^600 a Java Developer."],
    typeSpeed: 0,
    startDelay: 1000,
    loop: true
  });
...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(12.9470357, 77.7175412), // Bangalore
